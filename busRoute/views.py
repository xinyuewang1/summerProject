...
class homeView(generic.TemplateView):
    ...
    *****Does not include autocomplete yet****
    ...
    def post(self, request):
        ...
        weather = query_weather()
        args = {'form': form, 'source': source_address, 'time': time, 'destination': destination_address,
                'depart_time': depart_time, 'return_time': return_time, 'depart_date': depart_date,
                'return_date': return_date, 'weather': weather}
...
class stopsView(generic.TemplateView):
    ...
    def post(self, request):
        ...
        weather = query_weather()
        args = {'form': form, 'bus': bus, 'bikes': bikes, 'source': source_address, 'destination': destination_address,
                'depart_time': depart_time, 'depart_date': depart_date, 'arrival_time': arrival, 'est': est,
                'weather': weather}
        return render(request, self.template_name, args)
...
class routesView(generic.TemplateView):
    ...
    def post(self, request):
        ...
        weather = query_weather()
        args = {'form': form, 'source': source_address, 'destination': destination_address, 'depart_time': depart_time,
                'return_time': return_time, 'depart_date': depart_date, 'return_date': return_date, 'weather': weather}
        return render(request, self.template_name, args)
...
#source, dest, weather, time, month, day
...
#----------------TEST-----------
#print(Est39A('145', 768, 7586, 0, 18, "16:45", 3, "7/26/2018"))
